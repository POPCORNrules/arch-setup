...
pacstrap /mnt base base-devel linux linux-firmware intel-ucode xorg lightdm lightdm-webkit2-greeter dialog netctl iw dhcpcd wpa_supplicant inetutils awesome openssh git nano termite ttf-dejavu alsa-utils pacman-contrib acpid pavucontrol udisks2 light
