...
pacstrap /mnt base base-devel linux linux-firmware intel-ucode xorg lightdm lightdm-webkit2-greeter dialog netctl iw dhcpcd wpa_supplicant inetutils awesome openssh git nano termite picom alsa-utils pacman-contrib acpi acpid pavucontrol udisks2 light lxappearance unzip ranger atool w3m poppler mediainfo
