...
pacstrap /mnt base base-devel linux linux-firmware intel-ucode xorg lightdm lightdm-webkit2-greeter dialog netctl iw dhcpcd wpa_supplicant inetutils bluez bluez-utils blueman awesome openssh git nano termite picom alsa-utils pulseaudio pacman-contrib acpi acpid pavucontrol udisks2 light lxappearance unzip ranger atool w3m poppler mediainfo
